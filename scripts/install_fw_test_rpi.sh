...
curl -OL https://github.com/juribeparada/MMDVM_HS/releases/download/$FW_VERSION/zumspot_test_rpi_fw.bin
...
# Upload the firmware
eval sudo $STM32FLASH -v -w zumspot_test_rpi_fw.bin -g 0x0 -R -i 20,-21,21:-20,21 /dev/ttyAMA0
